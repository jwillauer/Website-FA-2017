...
root.bind('q','exit')
canvas = Canvas(root, width=WINDOW, height=.25*WINDOW, background='blue')
canvas.create_text(.1*WINDOW,.125*WINDOW,text=".33",font=("Arial", 24),tags="text",fill="#5b2b73")
canvas.create_rectangle(.2*WINDOW,.05*WINDOW,.3*WINDOW,.2*WINDOW, tags='rect1', fill='#807e82')
canvas.create_rectangle(.3*WINDOW,.05*WINDOW,.9*WINDOW,.2*WINDOW, tags='rect2', fill='#302b3d')
canvas.pack()
